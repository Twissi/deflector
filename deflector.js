void(function(window, document, defaults) {
    //
    ...
    Deflector.prototype.detect = function () {
        ...
        if (!result && this._includeLegacy) {
            ...
            result = regExp.test(this._userAgent.substring(0, 4));
        }
    ...
    Deflector.prototype.getPath = function () {
        if (this._pathMap.hasOwnProperty(this._path)) {
            return this._pathMap[this._path];
        }
        if (this._regExpPaths) {
            for (var key in this._pathMap) {
                if (this._pathMap.hasOwnProperty(key)) {
                    var regExp = new RegExp(key, 'i');
                    if (regExp.test(this._path)) {
                        return this._pathMap[key];
                    }
                }
            }
        }
        return this._defaultPath || this._path;
    };
    ...
    Deflector.prototype.getDomain = function () {
        var domain, hostName = this._domain;
